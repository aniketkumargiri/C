...
int main()
{
    FILE *ptr = NULL;
    FILE *ptr2 = NULL;
    ptr = fopen("69_bill.txt", "r");
    ptr2 = fopen("69_genBill.txt", "w");
    char str[200];
    fgets(str, 200, ptr);
    ...
    newStr = replaceWord(newStr, "{{name}}", "anikthe");
    printf("The actual bill generated is: %s\n", newStr);
    printf("The generated bill has been written to the file 69_genBill.txt\n");
